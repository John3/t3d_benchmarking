...
#include "T3D/gmk/physics/bullet/physicsBullet.h"
#endif

#ifdef TORQUE_PHYSICS_PHYSX3
#include "T3D/gmk/physics/physx/physicsPhysX.h"
#endif

#include "T3D/gmk/physics/physicsDummy.h"
#include "T3D/gmk/physics/physShapeDummy.h"
...
void Physics::init(const char * library)
{
	...
	{
		if (!dStricmp(library,"PhysX3"))
			mPhysLib = PHYSX3_LIB;
		else if (!dStricmp(library, "default") || !dStricmp(library,"Bullet"))
			mPhysLib = BULLET_LIB;
		else
		{
